...
func NewAbuseEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *AbuseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AbuseEntity) GetName() string { return e.name }
...
func (e *AbuseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AbuseEntity) Deleted() bool {
	return e.deleted
}


func (e *AbuseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAbuseEntity(e.client, opts)
}

func (e *AbuseEntity) Data(args ...any) any {
...
func (e *AbuseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Abuse; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AbuseEntity) DataTyped(data ...Abuse) Abuse {
	if len(data) > 0 {
		return typedFrom[Abuse](e.Data(asMap(data[0])))
	}
	return typedFrom[Abuse](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Abuse (all fields
// optional at the wire level).
func (e *AbuseEntity) MatchTyped(match ...Abuse) Abuse {
	if len(match) > 0 {
		return typedFrom[Abuse](e.Match(asMap(match[0])))
	}
	return typedFrom[Abuse](e.Match())
}
...
func (e *AbuseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AbuseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AbuseLoadMatch and returns an Abuse. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AbuseEntity) LoadTyped(reqmatch AbuseLoadMatch, ctrl map[string]any) (Abuse, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Abuse{}, err
	}
	return typedFrom[Abuse](res), nil
}



func (e *AbuseEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AbuseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AbuseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AbuseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AbuseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
