...
func NewIpinfoPlusEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *IpinfoPlusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpinfoPlusEntity) GetName() string { return e.name }
...
func (e *IpinfoPlusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpinfoPlusEntity) Deleted() bool {
	return e.deleted
}


func (e *IpinfoPlusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpinfoPlusEntity(e.client, opts)
}

func (e *IpinfoPlusEntity) Data(args ...any) any {
...
func (e *IpinfoPlusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IpinfoPlus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpinfoPlusEntity) DataTyped(data ...IpinfoPlus) IpinfoPlus {
	if len(data) > 0 {
		return typedFrom[IpinfoPlus](e.Data(asMap(data[0])))
	}
	return typedFrom[IpinfoPlus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IpinfoPlus (all fields
// optional at the wire level).
func (e *IpinfoPlusEntity) MatchTyped(match ...IpinfoPlus) IpinfoPlus {
	if len(match) > 0 {
		return typedFrom[IpinfoPlus](e.Match(asMap(match[0])))
	}
	return typedFrom[IpinfoPlus](e.Match())
}
...
func (e *IpinfoPlusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpinfoPlusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IpinfoPlusLoadMatch and returns an IpinfoPlus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IpinfoPlusEntity) LoadTyped(reqmatch IpinfoPlusLoadMatch, ctrl map[string]any) (IpinfoPlus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IpinfoPlus{}, err
	}
	return typedFrom[IpinfoPlus](res), nil
}



func (e *IpinfoPlusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IpinfoPlusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IpinfoPlusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IpinfoPlusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpinfoPlusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
