...
type GetInformationByIpEntity struct {
	name    string
...
func NewGetInformationByIpEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *GetInformationByIpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetInformationByIpEntity) GetName() string { return e.name }
...
func (e *GetInformationByIpEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetInformationByIpEntity) Deleted() bool {
	return e.deleted
}


func (e *GetInformationByIpEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetInformationByIpEntity(e.client, opts)
}

func (e *GetInformationByIpEntity) Data(args ...any) any {
...
func (e *GetInformationByIpEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetInformationByIp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetInformationByIpEntity) DataTyped(data ...GetInformationByIp) GetInformationByIp {
	if len(data) > 0 {
		return typedFrom[GetInformationByIp](e.Data(asMap(data[0])))
	}
	return typedFrom[GetInformationByIp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetInformationByIp (all fields
// optional at the wire level).
func (e *GetInformationByIpEntity) MatchTyped(match ...GetInformationByIp) GetInformationByIp {
	if len(match) > 0 {
		return typedFrom[GetInformationByIp](e.Match(asMap(match[0])))
	}
	return typedFrom[GetInformationByIp](e.Match())
}
...
func (e *GetInformationByIpEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetInformationByIpEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetInformationByIpLoadMatch and returns an GetInformationByIp. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetInformationByIpEntity) LoadTyped(reqmatch GetInformationByIpLoadMatch, ctrl map[string]any) (GetInformationByIp, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetInformationByIp{}, err
	}
	return typedFrom[GetInformationByIp](res), nil
}



func (e *GetInformationByIpEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetInformationByIpEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetInformationByIpEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetInformationByIpEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetInformationByIpEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
