...
func NewWhoisDomainEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *WhoisDomainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhoisDomainEntity) GetName() string { return e.name }
...
func (e *WhoisDomainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WhoisDomainEntity) Deleted() bool {
	return e.deleted
}


func (e *WhoisDomainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhoisDomainEntity(e.client, opts)
}

func (e *WhoisDomainEntity) Data(args ...any) any {
...
func (e *WhoisDomainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WhoisDomain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WhoisDomainEntity) DataTyped(data ...WhoisDomain) WhoisDomain {
	if len(data) > 0 {
		return typedFrom[WhoisDomain](e.Data(asMap(data[0])))
	}
	return typedFrom[WhoisDomain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WhoisDomain (all fields
// optional at the wire level).
func (e *WhoisDomainEntity) MatchTyped(match ...WhoisDomain) WhoisDomain {
	if len(match) > 0 {
		return typedFrom[WhoisDomain](e.Match(asMap(match[0])))
	}
	return typedFrom[WhoisDomain](e.Match())
}
...
func (e *WhoisDomainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhoisDomainEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WhoisDomainLoadMatch and returns an WhoisDomain. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WhoisDomainEntity) LoadTyped(reqmatch WhoisDomainLoadMatch, ctrl map[string]any) (WhoisDomain, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WhoisDomain{}, err
	}
	return typedFrom[WhoisDomain](res), nil
}



func (e *WhoisDomainEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WhoisDomainEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhoisDomainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhoisDomainEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WhoisDomainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
