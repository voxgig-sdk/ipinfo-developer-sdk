...
func NewWhoisNetIdEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *WhoisNetIdEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhoisNetIdEntity) GetName() string { return e.name }
...
func (e *WhoisNetIdEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WhoisNetIdEntity) Deleted() bool {
	return e.deleted
}


func (e *WhoisNetIdEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhoisNetIdEntity(e.client, opts)
}

func (e *WhoisNetIdEntity) Data(args ...any) any {
...
func (e *WhoisNetIdEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WhoisNetId; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WhoisNetIdEntity) DataTyped(data ...WhoisNetId) WhoisNetId {
	if len(data) > 0 {
		return typedFrom[WhoisNetId](e.Data(asMap(data[0])))
	}
	return typedFrom[WhoisNetId](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WhoisNetId (all fields
// optional at the wire level).
func (e *WhoisNetIdEntity) MatchTyped(match ...WhoisNetId) WhoisNetId {
	if len(match) > 0 {
		return typedFrom[WhoisNetId](e.Match(asMap(match[0])))
	}
	return typedFrom[WhoisNetId](e.Match())
}
...
func (e *WhoisNetIdEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhoisNetIdEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WhoisNetIdLoadMatch and returns an WhoisNetId. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WhoisNetIdEntity) LoadTyped(reqmatch WhoisNetIdLoadMatch, ctrl map[string]any) (WhoisNetId, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WhoisNetId{}, err
	}
	return typedFrom[WhoisNetId](res), nil
}



func (e *WhoisNetIdEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WhoisNetIdEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhoisNetIdEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhoisNetIdEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WhoisNetIdEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
