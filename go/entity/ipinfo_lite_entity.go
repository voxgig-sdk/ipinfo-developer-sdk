...
func NewIpinfoLiteEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *IpinfoLiteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpinfoLiteEntity) GetName() string { return e.name }
...
func (e *IpinfoLiteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpinfoLiteEntity) Deleted() bool {
	return e.deleted
}


func (e *IpinfoLiteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpinfoLiteEntity(e.client, opts)
}

func (e *IpinfoLiteEntity) Data(args ...any) any {
...
func (e *IpinfoLiteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IpinfoLite; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpinfoLiteEntity) DataTyped(data ...IpinfoLite) IpinfoLite {
	if len(data) > 0 {
		return typedFrom[IpinfoLite](e.Data(asMap(data[0])))
	}
	return typedFrom[IpinfoLite](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IpinfoLite (all fields
// optional at the wire level).
func (e *IpinfoLiteEntity) MatchTyped(match ...IpinfoLite) IpinfoLite {
	if len(match) > 0 {
		return typedFrom[IpinfoLite](e.Match(asMap(match[0])))
	}
	return typedFrom[IpinfoLite](e.Match())
}
...
func (e *IpinfoLiteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpinfoLiteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IpinfoLiteLoadMatch and returns an IpinfoLite. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IpinfoLiteEntity) LoadTyped(reqmatch IpinfoLiteLoadMatch, ctrl map[string]any) (IpinfoLite, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IpinfoLite{}, err
	}
	return typedFrom[IpinfoLite](res), nil
}



func (e *IpinfoLiteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IpinfoLiteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IpinfoLiteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IpinfoLiteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpinfoLiteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
