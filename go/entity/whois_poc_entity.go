...
func NewWhoisPocEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *WhoisPocEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhoisPocEntity) GetName() string { return e.name }
...
func (e *WhoisPocEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WhoisPocEntity) Deleted() bool {
	return e.deleted
}


func (e *WhoisPocEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhoisPocEntity(e.client, opts)
}

func (e *WhoisPocEntity) Data(args ...any) any {
...
func (e *WhoisPocEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WhoisPoc; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WhoisPocEntity) DataTyped(data ...WhoisPoc) WhoisPoc {
	if len(data) > 0 {
		return typedFrom[WhoisPoc](e.Data(asMap(data[0])))
	}
	return typedFrom[WhoisPoc](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WhoisPoc (all fields
// optional at the wire level).
func (e *WhoisPocEntity) MatchTyped(match ...WhoisPoc) WhoisPoc {
	if len(match) > 0 {
		return typedFrom[WhoisPoc](e.Match(asMap(match[0])))
	}
	return typedFrom[WhoisPoc](e.Match())
}
...
func (e *WhoisPocEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhoisPocEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WhoisPocLoadMatch and returns an WhoisPoc. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WhoisPocEntity) LoadTyped(reqmatch WhoisPocLoadMatch, ctrl map[string]any) (WhoisPoc, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WhoisPoc{}, err
	}
	return typedFrom[WhoisPoc](res), nil
}



func (e *WhoisPocEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WhoisPocEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhoisPocEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhoisPocEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WhoisPocEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
