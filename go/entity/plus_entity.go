...
func NewPlusEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *PlusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlusEntity) GetName() string { return e.name }
...
func (e *PlusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlusEntity) Deleted() bool {
	return e.deleted
}


func (e *PlusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlusEntity(e.client, opts)
}

func (e *PlusEntity) Data(args ...any) any {
...
func (e *PlusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Plus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlusEntity) DataTyped(data ...Plus) Plus {
	if len(data) > 0 {
		return typedFrom[Plus](e.Data(asMap(data[0])))
	}
	return typedFrom[Plus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Plus (all fields
// optional at the wire level).
func (e *PlusEntity) MatchTyped(match ...Plus) Plus {
	if len(match) > 0 {
		return typedFrom[Plus](e.Match(asMap(match[0])))
	}
	return typedFrom[Plus](e.Match())
}
...
func (e *PlusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlusLoadMatch and returns an Plus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PlusEntity) LoadTyped(reqmatch PlusLoadMatch, ctrl map[string]any) (Plus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Plus{}, err
	}
	return typedFrom[Plus](res), nil
}



func (e *PlusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PlusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
