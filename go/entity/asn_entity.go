...
func NewAsnEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *AsnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AsnEntity) GetName() string { return e.name }
...
func (e *AsnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AsnEntity) Deleted() bool {
	return e.deleted
}


func (e *AsnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAsnEntity(e.client, opts)
}

func (e *AsnEntity) Data(args ...any) any {
...
func (e *AsnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Asn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AsnEntity) DataTyped(data ...Asn) Asn {
	if len(data) > 0 {
		return typedFrom[Asn](e.Data(asMap(data[0])))
	}
	return typedFrom[Asn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Asn (all fields
// optional at the wire level).
func (e *AsnEntity) MatchTyped(match ...Asn) Asn {
	if len(match) > 0 {
		return typedFrom[Asn](e.Match(asMap(match[0])))
	}
	return typedFrom[Asn](e.Match())
}
...
func (e *AsnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AsnEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AsnEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AsnListMatch and returns []Asn. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AsnEntity) ListTyped(reqmatch AsnListMatch, ctrl map[string]any) ([]Asn, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Asn](res), nil
}



func (e *AsnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AsnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AsnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AsnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
