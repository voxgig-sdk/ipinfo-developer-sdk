...
func NewRangeEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *RangeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RangeEntity) GetName() string { return e.name }
...
func (e *RangeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RangeEntity) Deleted() bool {
	return e.deleted
}


func (e *RangeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRangeEntity(e.client, opts)
}

func (e *RangeEntity) Data(args ...any) any {
...
func (e *RangeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Range; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RangeEntity) DataTyped(data ...Range) Range {
	if len(data) > 0 {
		return typedFrom[Range](e.Data(asMap(data[0])))
	}
	return typedFrom[Range](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Range (all fields
// optional at the wire level).
func (e *RangeEntity) MatchTyped(match ...Range) Range {
	if len(match) > 0 {
		return typedFrom[Range](e.Match(asMap(match[0])))
	}
	return typedFrom[Range](e.Match())
}
...
func (e *RangeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RangeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RangeLoadMatch and returns an Range. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RangeEntity) LoadTyped(reqmatch RangeLoadMatch, ctrl map[string]any) (Range, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Range{}, err
	}
	return typedFrom[Range](res), nil
}



func (e *RangeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RangeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RangeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RangeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RangeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
