...
func NewPrivacyEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *PrivacyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PrivacyEntity) GetName() string { return e.name }
...
func (e *PrivacyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PrivacyEntity) Deleted() bool {
	return e.deleted
}


func (e *PrivacyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPrivacyEntity(e.client, opts)
}

func (e *PrivacyEntity) Data(args ...any) any {
...
func (e *PrivacyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PrivacyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PrivacyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PrivacyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PrivacyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PrivacyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PrivacyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
