...
type ResidentialProxyEntity struct {
	name    string
...
func NewResidentialProxyEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *ResidentialProxyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResidentialProxyEntity) GetName() string { return e.name }
...
func (e *ResidentialProxyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ResidentialProxyEntity) Deleted() bool {
	return e.deleted
}


func (e *ResidentialProxyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewResidentialProxyEntity(e.client, opts)
}

func (e *ResidentialProxyEntity) Data(args ...any) any {
...
func (e *ResidentialProxyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ResidentialProxy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ResidentialProxyEntity) DataTyped(data ...ResidentialProxy) ResidentialProxy {
	if len(data) > 0 {
		return typedFrom[ResidentialProxy](e.Data(asMap(data[0])))
	}
	return typedFrom[ResidentialProxy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ResidentialProxy (all fields
// optional at the wire level).
func (e *ResidentialProxyEntity) MatchTyped(match ...ResidentialProxy) ResidentialProxy {
	if len(match) > 0 {
		return typedFrom[ResidentialProxy](e.Match(asMap(match[0])))
	}
	return typedFrom[ResidentialProxy](e.Match())
}
...
func (e *ResidentialProxyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ResidentialProxyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ResidentialProxyLoadMatch and returns an ResidentialProxy. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ResidentialProxyEntity) LoadTyped(reqmatch ResidentialProxyLoadMatch, ctrl map[string]any) (ResidentialProxy, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ResidentialProxy{}, err
	}
	return typedFrom[ResidentialProxy](res), nil
}



func (e *ResidentialProxyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ResidentialProxyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ResidentialProxyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ResidentialProxyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ResidentialProxyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
