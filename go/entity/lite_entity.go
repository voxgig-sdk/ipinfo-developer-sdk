...
func NewLiteEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *LiteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LiteEntity) GetName() string { return e.name }
...
func (e *LiteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LiteEntity) Deleted() bool {
	return e.deleted
}


func (e *LiteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLiteEntity(e.client, opts)
}

func (e *LiteEntity) Data(args ...any) any {
...
func (e *LiteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Lite; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LiteEntity) DataTyped(data ...Lite) Lite {
	if len(data) > 0 {
		return typedFrom[Lite](e.Data(asMap(data[0])))
	}
	return typedFrom[Lite](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Lite (all fields
// optional at the wire level).
func (e *LiteEntity) MatchTyped(match ...Lite) Lite {
	if len(match) > 0 {
		return typedFrom[Lite](e.Match(asMap(match[0])))
	}
	return typedFrom[Lite](e.Match())
}
...
func (e *LiteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LiteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LiteLoadMatch and returns an Lite. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LiteEntity) LoadTyped(reqmatch LiteLoadMatch, ctrl map[string]any) (Lite, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Lite{}, err
	}
	return typedFrom[Lite](res), nil
}



func (e *LiteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LiteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LiteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LiteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LiteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
