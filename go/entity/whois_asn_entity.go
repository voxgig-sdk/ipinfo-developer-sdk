...
func NewWhoisAsnEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *WhoisAsnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhoisAsnEntity) GetName() string { return e.name }
...
func (e *WhoisAsnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WhoisAsnEntity) Deleted() bool {
	return e.deleted
}


func (e *WhoisAsnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhoisAsnEntity(e.client, opts)
}

func (e *WhoisAsnEntity) Data(args ...any) any {
...
func (e *WhoisAsnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WhoisAsn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WhoisAsnEntity) DataTyped(data ...WhoisAsn) WhoisAsn {
	if len(data) > 0 {
		return typedFrom[WhoisAsn](e.Data(asMap(data[0])))
	}
	return typedFrom[WhoisAsn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WhoisAsn (all fields
// optional at the wire level).
func (e *WhoisAsnEntity) MatchTyped(match ...WhoisAsn) WhoisAsn {
	if len(match) > 0 {
		return typedFrom[WhoisAsn](e.Match(asMap(match[0])))
	}
	return typedFrom[WhoisAsn](e.Match())
}
...
func (e *WhoisAsnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhoisAsnEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *WhoisAsnEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WhoisAsnListMatch and returns []WhoisAsn. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WhoisAsnEntity) ListTyped(reqmatch WhoisAsnListMatch, ctrl map[string]any) ([]WhoisAsn, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[WhoisAsn](res), nil
}



func (e *WhoisAsnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhoisAsnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhoisAsnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WhoisAsnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
