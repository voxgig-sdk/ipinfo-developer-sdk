...
func NewCarrierEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *CarrierEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CarrierEntity) GetName() string { return e.name }
...
func (e *CarrierEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CarrierEntity) Deleted() bool {
	return e.deleted
}


func (e *CarrierEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCarrierEntity(e.client, opts)
}

func (e *CarrierEntity) Data(args ...any) any {
...
func (e *CarrierEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Carrier; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CarrierEntity) DataTyped(data ...Carrier) Carrier {
	if len(data) > 0 {
		return typedFrom[Carrier](e.Data(asMap(data[0])))
	}
	return typedFrom[Carrier](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Carrier (all fields
// optional at the wire level).
func (e *CarrierEntity) MatchTyped(match ...Carrier) Carrier {
	if len(match) > 0 {
		return typedFrom[Carrier](e.Match(asMap(match[0])))
	}
	return typedFrom[Carrier](e.Match())
}
...
func (e *CarrierEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CarrierEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CarrierLoadMatch and returns an Carrier. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CarrierEntity) LoadTyped(reqmatch CarrierLoadMatch, ctrl map[string]any) (Carrier, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Carrier{}, err
	}
	return typedFrom[Carrier](res), nil
}



func (e *CarrierEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CarrierEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CarrierEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CarrierEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CarrierEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
