...
func NewSingleEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *SingleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SingleEntity) GetName() string { return e.name }
...
func (e *SingleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SingleEntity) Deleted() bool {
	return e.deleted
}


func (e *SingleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSingleEntity(e.client, opts)
}

func (e *SingleEntity) Data(args ...any) any {
...
func (e *SingleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Single; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SingleEntity) DataTyped(data ...Single) Single {
	if len(data) > 0 {
		return typedFrom[Single](e.Data(asMap(data[0])))
	}
	return typedFrom[Single](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Single (all fields
// optional at the wire level).
func (e *SingleEntity) MatchTyped(match ...Single) Single {
	if len(match) > 0 {
		return typedFrom[Single](e.Match(asMap(match[0])))
	}
	return typedFrom[Single](e.Match())
}
...
func (e *SingleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SingleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SingleLoadMatch and returns an Single. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SingleEntity) LoadTyped(reqmatch SingleLoadMatch, ctrl map[string]any) (Single, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Single{}, err
	}
	return typedFrom[Single](res), nil
}



func (e *SingleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SingleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SingleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SingleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SingleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
