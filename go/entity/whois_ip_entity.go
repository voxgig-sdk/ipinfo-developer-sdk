...
func NewWhoisIpEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *WhoisIpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhoisIpEntity) GetName() string { return e.name }
...
func (e *WhoisIpEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WhoisIpEntity) Deleted() bool {
	return e.deleted
}


func (e *WhoisIpEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhoisIpEntity(e.client, opts)
}

func (e *WhoisIpEntity) Data(args ...any) any {
...
func (e *WhoisIpEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *WhoisIpEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhoisIpEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WhoisIpEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhoisIpEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhoisIpEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WhoisIpEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
