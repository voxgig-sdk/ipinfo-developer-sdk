...
type PrivacyExtendedEntity struct {
	name    string
...
func NewPrivacyExtendedEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *PrivacyExtendedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PrivacyExtendedEntity) GetName() string { return e.name }
...
func (e *PrivacyExtendedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PrivacyExtendedEntity) Deleted() bool {
	return e.deleted
}


func (e *PrivacyExtendedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPrivacyExtendedEntity(e.client, opts)
}

func (e *PrivacyExtendedEntity) Data(args ...any) any {
...
func (e *PrivacyExtendedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PrivacyExtended; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PrivacyExtendedEntity) DataTyped(data ...PrivacyExtended) PrivacyExtended {
	if len(data) > 0 {
		return typedFrom[PrivacyExtended](e.Data(asMap(data[0])))
	}
	return typedFrom[PrivacyExtended](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PrivacyExtended (all fields
// optional at the wire level).
func (e *PrivacyExtendedEntity) MatchTyped(match ...PrivacyExtended) PrivacyExtended {
	if len(match) > 0 {
		return typedFrom[PrivacyExtended](e.Match(asMap(match[0])))
	}
	return typedFrom[PrivacyExtended](e.Match())
}
...
func (e *PrivacyExtendedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PrivacyExtendedEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PrivacyExtendedEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PrivacyExtendedListMatch and returns []PrivacyExtended. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PrivacyExtendedEntity) ListTyped(reqmatch PrivacyExtendedListMatch, ctrl map[string]any) ([]PrivacyExtended, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PrivacyExtended](res), nil
}



func (e *PrivacyExtendedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PrivacyExtendedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PrivacyExtendedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PrivacyExtendedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
