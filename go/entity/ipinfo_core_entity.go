...
func NewIpinfoCoreEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *IpinfoCoreEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpinfoCoreEntity) GetName() string { return e.name }
...
func (e *IpinfoCoreEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpinfoCoreEntity) Deleted() bool {
	return e.deleted
}


func (e *IpinfoCoreEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpinfoCoreEntity(e.client, opts)
}

func (e *IpinfoCoreEntity) Data(args ...any) any {
...
func (e *IpinfoCoreEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IpinfoCore; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpinfoCoreEntity) DataTyped(data ...IpinfoCore) IpinfoCore {
	if len(data) > 0 {
		return typedFrom[IpinfoCore](e.Data(asMap(data[0])))
	}
	return typedFrom[IpinfoCore](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IpinfoCore (all fields
// optional at the wire level).
func (e *IpinfoCoreEntity) MatchTyped(match ...IpinfoCore) IpinfoCore {
	if len(match) > 0 {
		return typedFrom[IpinfoCore](e.Match(asMap(match[0])))
	}
	return typedFrom[IpinfoCore](e.Match())
}
...
func (e *IpinfoCoreEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpinfoCoreEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IpinfoCoreLoadMatch and returns an IpinfoCore. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IpinfoCoreEntity) LoadTyped(reqmatch IpinfoCoreLoadMatch, ctrl map[string]any) (IpinfoCore, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IpinfoCore{}, err
	}
	return typedFrom[IpinfoCore](res), nil
}



func (e *IpinfoCoreEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IpinfoCoreEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IpinfoCoreEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IpinfoCoreEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpinfoCoreEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
