...
func NewWhoisOrgEntity(client *core.IpinfoDeveloperSDK, entopts map[string]any) *WhoisOrgEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhoisOrgEntity) GetName() string { return e.name }
...
func (e *WhoisOrgEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WhoisOrgEntity) Deleted() bool {
	return e.deleted
}


func (e *WhoisOrgEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhoisOrgEntity(e.client, opts)
}

func (e *WhoisOrgEntity) Data(args ...any) any {
...
func (e *WhoisOrgEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WhoisOrg; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WhoisOrgEntity) DataTyped(data ...WhoisOrg) WhoisOrg {
	if len(data) > 0 {
		return typedFrom[WhoisOrg](e.Data(asMap(data[0])))
	}
	return typedFrom[WhoisOrg](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WhoisOrg (all fields
// optional at the wire level).
func (e *WhoisOrgEntity) MatchTyped(match ...WhoisOrg) WhoisOrg {
	if len(match) > 0 {
		return typedFrom[WhoisOrg](e.Match(asMap(match[0])))
	}
	return typedFrom[WhoisOrg](e.Match())
}
...
func (e *WhoisOrgEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhoisOrgEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WhoisOrgLoadMatch and returns an WhoisOrg. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WhoisOrgEntity) LoadTyped(reqmatch WhoisOrgLoadMatch, ctrl map[string]any) (WhoisOrg, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WhoisOrg{}, err
	}
	return typedFrom[WhoisOrg](res), nil
}



func (e *WhoisOrgEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WhoisOrgEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhoisOrgEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhoisOrgEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WhoisOrgEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
