...
func TestIpinfoLiteEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		ipinfoLiteRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.ipinfo_lite")))
...
func ipinfo_liteBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("IPINFO_DEVELOPER_TEST_IPINFO_LITE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["IPINFO_DEVELOPER_TEST_IPINFO_LITE_ENTID"])
