...
func TestGetCurrentInformationEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		getCurrentInformationRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.get_current_information")))
...
func get_current_informationBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("IPINFO_DEVELOPER_TEST_GET_CURRENT_INFORMATION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["IPINFO_DEVELOPER_TEST_GET_CURRENT_INFORMATION_ENTID"])
