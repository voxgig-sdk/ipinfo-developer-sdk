...
const testSeed = `map[string]any{"entity": map[string]any{"abuse": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "asn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "carrier": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "core": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "general": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_current_information": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_information_by_ip": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ipinfo_core": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ipinfo_lite": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ipinfo_plus": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lite": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "max": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "men": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "place": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "plus": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "privacy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "privacy_extended": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "range": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "residential_proxy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "single": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whois_asn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whois_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whois_ip": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whois_net_id": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whois_org": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whois_poc": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
