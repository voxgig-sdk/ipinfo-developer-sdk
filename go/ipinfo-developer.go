...
// instead of `sdk.NewIpinfoDeveloperSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *IpinfoDeveloperSDK  { return NewIpinfoDeveloperSDK(nil) }
func Test() *IpinfoDeveloperSDK { return TestSDK(nil, nil) }
