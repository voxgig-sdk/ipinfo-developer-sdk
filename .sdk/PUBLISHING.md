...
|---|---|---|
| `ts/` | @voxgig-sdk/ipinfo-developer-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ipinfo-developer-sdk \
      --repository voxgig-sdk/ipinfo-developer-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ipinfo-developer-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ipinfo-developer-sdk --id=<id>` removes it.
