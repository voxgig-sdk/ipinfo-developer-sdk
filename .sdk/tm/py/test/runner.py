...
class IpinfoDeveloperTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpinfoDeveloperTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IpinfoDeveloperTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IpinfoDeveloperTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
