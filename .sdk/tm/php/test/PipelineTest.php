...
// IpinfoDeveloper SDK pipeline test
//
...
{
    private static function utility(): IpinfoDeveloperUtility
    {
        return new IpinfoDeveloperUtility();
    }
    ...
    private static function ctx(array $over = []): IpinfoDeveloperContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IpinfoDeveloperContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IpinfoDeveloperOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IpinfoDeveloperError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IpinfoDeveloperOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IpinfoDeveloperMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IpinfoDeveloperOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IpinfoDeveloperMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IpinfoDeveloperOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IpinfoDeveloperMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpinfoDeveloperSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IpinfoDeveloperMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IpinfoDeveloperResponse([]),
            'result' => new IpinfoDeveloperResult([]),
        ]);
        [, $err] = IpinfoDeveloperMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IpinfoDeveloperSpec([]),
            'response' => null,
            'result' => new IpinfoDeveloperResult([]),
        ]);
        [, $err] = IpinfoDeveloperMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IpinfoDeveloperSpec(['step' => 's']),
            'response' => new IpinfoDeveloperResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IpinfoDeveloperResult([]),
        ]);
        [, $err] = IpinfoDeveloperMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IpinfoDeveloperSpec(['step' => 's']),
            'response' => new IpinfoDeveloperResponse(self::resp(200, ['v' => 1])),
            'result' => new IpinfoDeveloperResult([]),
        ]);
        [, $err] = IpinfoDeveloperMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IpinfoDeveloperSpec(['step' => 's']),
            'response' => new IpinfoDeveloperResponse(self::resp(200, ['v' => 2])),
            'result' => new IpinfoDeveloperResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IpinfoDeveloperMakeResponse::call($ctx);
    ...
    {
        $preset = new IpinfoDeveloperResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IpinfoDeveloperSpec([]),
            'response' => new IpinfoDeveloperResponse([]),
            'result' => new IpinfoDeveloperResult([]),
        ...
        [$got, $err] = IpinfoDeveloperMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IpinfoDeveloperResult([])]);
        [, $err] = IpinfoDeveloperMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IpinfoDeveloperSpec([]), 'result' => null]);
        [, $err] = IpinfoDeveloperMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpinfoDeveloperSpec(['step' => 's']),
            'result' => new IpinfoDeveloperResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IpinfoDeveloperOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpinfoDeveloperMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpinfoDeveloperSpec(['step' => 's']),
            'result' => new IpinfoDeveloperResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IpinfoDeveloperOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpinfoDeveloperMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpinfoDeveloperResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IpinfoDeveloperSpec([]),
            'result' => new IpinfoDeveloperResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IpinfoDeveloperMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpinfoDeveloperMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IpinfoDeveloperError('boom', 'boom');
        $utility->fetcher = function (IpinfoDeveloperContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpinfoDeveloperSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IpinfoDeveloperMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IpinfoDeveloperContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IpinfoDeveloperMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IpinfoDeveloperResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        IpinfoDeveloperMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IpinfoDeveloperContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpinfoDeveloperSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IpinfoDeveloperMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IpinfoDeveloperResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IpinfoDeveloperSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IpinfoDeveloperMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IpinfoDeveloperMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IpinfoDeveloperMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IpinfoDeveloperResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IpinfoDeveloperDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IpinfoDeveloperResult(['ok' => false])]);
        $this->expectException(IpinfoDeveloperError::class);
        IpinfoDeveloperDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IpinfoDeveloperResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IpinfoDeveloperMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IpinfoDeveloperMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IpinfoDeveloperBaseFeature();
        $b = new IpinfoDeveloperBaseFeature();
        IpinfoDeveloperFeatureAdd::call($ctx, $a);
        IpinfoDeveloperFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IpinfoDeveloperBaseFeature
    {
        $f = new IpinfoDeveloperBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IpinfoDeveloperFeatureAdd::call($ctx, self::named_feature('a'));
        IpinfoDeveloperFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        IpinfoDeveloperFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        IpinfoDeveloperFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        IpinfoDeveloperFeatureAdd::call($ctx, $replace);
        ...
        IpinfoDeveloperFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IpinfoDeveloperContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IpinfoDeveloperSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpinfoDeveloperPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        IpinfoDeveloperPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IpinfoDeveloperResponse(['headers' => null]),
            'result' => new IpinfoDeveloperResult([]),
        ]);
        IpinfoDeveloperResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        IpinfoDeveloperResultBody::call($ctx);
