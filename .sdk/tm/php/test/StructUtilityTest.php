...
// IpinfoDeveloper SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IpinfoDeveloperOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IpinfoDeveloperOmni::structfix($now, Struct::undef()))
                        !== json_encode(IpinfoDeveloperOmni::structfix($val, Struct::undef()))) {
