...
// IpinfoDeveloper SDK audit feature
...
class IpinfoDeveloperAuditFeature extends IpinfoDeveloperBaseFeature
{
    ...
    private function _emit(IpinfoDeveloperContext $ctx, string $outcome): void
    {
