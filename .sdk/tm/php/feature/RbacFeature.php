...
// IpinfoDeveloper SDK rbac feature
...
class IpinfoDeveloperRbacFeature extends IpinfoDeveloperBaseFeature
{
    ...
    private function _required(IpinfoDeveloperContext $ctx): ?string
    {
    ...
    private function _reject(IpinfoDeveloperContext $ctx, string $required): void
    {
    ...
    private function _track(IpinfoDeveloperContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
