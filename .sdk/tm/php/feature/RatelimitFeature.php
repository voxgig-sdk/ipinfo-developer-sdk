...
// IpinfoDeveloper SDK ratelimit feature
...
class IpinfoDeveloperRatelimitFeature extends IpinfoDeveloperBaseFeature
{
    ...
    private function _acquire(IpinfoDeveloperContext $ctx): void
    {
    ...
    private function _track(IpinfoDeveloperContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
