...
// IpinfoDeveloper SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IpinfoDeveloperTestFeature extends IpinfoDeveloperBaseFeature
{
    ...
    public function init(IpinfoDeveloperContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IpinfoDeveloperContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = IpinfoDeveloperParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IpinfoDeveloperContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IpinfoDeveloperContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = IpinfoDeveloperParam::call($ctx, $k);
