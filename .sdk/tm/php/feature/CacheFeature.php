...
// IpinfoDeveloper SDK cache feature
...
class IpinfoDeveloperCacheFeature extends IpinfoDeveloperBaseFeature
{
    ...
    private function _through(IpinfoDeveloperContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
