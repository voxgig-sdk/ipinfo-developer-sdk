...
// IpinfoDeveloper SDK utility: graphql
//
...
class IpinfoDeveloperGraphql
{
    ...
    // equivalent.
    public static function body(IpinfoDeveloperContext $ctx): mixed
    {
    ...
    public static function errors(IpinfoDeveloperContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
