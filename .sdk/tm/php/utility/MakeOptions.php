...
// IpinfoDeveloper SDK utility: make_options

class IpinfoDeveloperMakeOptions
{
    ...
    public static function call(IpinfoDeveloperContext $ctx): array
    {
        ...
        //
        // `IpinfoDeveloperSchema::optspec()` is built from the model:
        ...
        $optspec = IpinfoDeveloperSchema::optspec();
