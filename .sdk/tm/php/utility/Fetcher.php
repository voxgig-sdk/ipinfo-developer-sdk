...
// IpinfoDeveloper SDK utility: fetcher

class IpinfoDeveloperFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpinfoDeveloperSDK/1.0)';
    ...
    public static function call(IpinfoDeveloperContext $ctx, string $fullurl, array $fetchdef): array
    {
