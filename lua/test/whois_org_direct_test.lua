...
describe("WhoisOrgDirect", function()
  it("should direct-load-whois_org", function()
    local setup = whois_org_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-whois_org", setup.live and "live" or "unit")
...
function whois_org_direct_setup(mockres)
