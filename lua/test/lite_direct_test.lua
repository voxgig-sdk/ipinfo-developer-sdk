...
describe("LiteDirect", function()
  it("should direct-load-lite", function()
    local setup = lite_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-lite", setup.live and "live" or "unit")
...
function lite_direct_setup(mockres)
