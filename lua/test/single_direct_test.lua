...
describe("SingleDirect", function()
  it("should direct-load-single", function()
    local setup = single_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-single", setup.live and "live" or "unit")
...
function single_direct_setup(mockres)
