...
describe("IpinfoCoreDirect", function()
  it("should direct-load-ipinfo_core", function()
    local setup = ipinfo_core_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ipinfo_core", setup.live and "live" or "unit")
...
function ipinfo_core_direct_setup(mockres)
