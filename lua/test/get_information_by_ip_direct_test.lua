-- GetInformationByIp direct test
...
describe("GetInformationByIpDirect", function()
  it("should direct-load-get_information_by_ip", function()
    local setup = get_information_by_ip_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_information_by_ip", setup.live and "live" or "unit")
...
function get_information_by_ip_direct_setup(mockres)
