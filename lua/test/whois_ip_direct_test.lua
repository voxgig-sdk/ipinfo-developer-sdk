...
describe("WhoisIpDirect", function()
  it("should direct-load-whois_ip", function()
    local setup = whois_ip_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-whois_ip", setup.live and "live" or "unit")
...
function whois_ip_direct_setup(mockres)
