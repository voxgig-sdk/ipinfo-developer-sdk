...
describe("WhoisPocDirect", function()
  it("should direct-load-whois_poc", function()
    local setup = whois_poc_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-whois_poc", setup.live and "live" or "unit")
...
function whois_poc_direct_setup(mockres)
