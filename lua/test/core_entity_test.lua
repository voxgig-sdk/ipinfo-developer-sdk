...
describe("CoreEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set IPINFO_DEVELOPER_TEST_CORE_ENTID JSON to run live")
      return
    end
...
function core_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("IPINFO_DEVELOPER_TEST_CORE_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["IPINFO_DEVELOPER_TEST_CORE_ENTID"])
