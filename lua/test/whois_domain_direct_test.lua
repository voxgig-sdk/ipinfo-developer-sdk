...
describe("WhoisDomainDirect", function()
  it("should direct-load-whois_domain", function()
    local setup = whois_domain_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-whois_domain", setup.live and "live" or "unit")
...
function whois_domain_direct_setup(mockres)
