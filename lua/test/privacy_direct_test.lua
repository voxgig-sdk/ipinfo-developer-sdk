...
describe("PrivacyDirect", function()
  it("should direct-load-privacy", function()
    local setup = privacy_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-privacy", setup.live and "live" or "unit")
...
function privacy_direct_setup(mockres)
