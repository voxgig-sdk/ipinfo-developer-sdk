...
describe("CarrierDirect", function()
  it("should direct-load-carrier", function()
    local setup = carrier_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-carrier", setup.live and "live" or "unit")
...
function carrier_direct_setup(mockres)
