...
describe("WhoisNetIdDirect", function()
  it("should direct-load-whois_net_id", function()
    local setup = whois_net_id_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-whois_net_id", setup.live and "live" or "unit")
...
function whois_net_id_direct_setup(mockres)
