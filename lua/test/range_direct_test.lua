...
describe("RangeDirect", function()
  it("should direct-load-range", function()
    local setup = range_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-range", setup.live and "live" or "unit")
...
function range_direct_setup(mockres)
