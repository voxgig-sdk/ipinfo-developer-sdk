...
describe("ResidentialProxyDirect", function()
  it("should direct-load-residential_proxy", function()
    local setup = residential_proxy_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-residential_proxy", setup.live and "live" or "unit")
...
function residential_proxy_direct_setup(mockres)
