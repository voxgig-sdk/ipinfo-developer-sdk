...
describe("WhoisAsnDirect", function()
  it("should direct-list-whois_asn", function()
    local setup = whois_asn_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-whois_asn", setup.live and "live" or "unit")
