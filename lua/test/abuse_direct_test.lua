...
describe("AbuseDirect", function()
  it("should direct-load-abuse", function()
    local setup = abuse_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-abuse", setup.live and "live" or "unit")
...
function abuse_direct_setup(mockres)
