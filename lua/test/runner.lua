...
function runner.env_override(m)
  local live = runner.getenv("IPINFO_DEVELOPER_TEST_LIVE")
  local override = runner.getenv("IPINFO_DEVELOPER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IPINFO_DEVELOPER_TEST_EXPLAIN")
