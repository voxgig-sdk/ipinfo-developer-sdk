...
function runner.env_override(m)
  local live = runner.getenv("IPINFODEVELOPER_TEST_LIVE")
  local override = runner.getenv("IPINFODEVELOPER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IPINFODEVELOPER_TEST_EXPLAIN")
