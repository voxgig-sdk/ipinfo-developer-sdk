...
describe("PlusDirect", function()
  it("should direct-load-plus", function()
    local setup = plus_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-plus", setup.live and "live" or "unit")
...
function plus_direct_setup(mockres)
