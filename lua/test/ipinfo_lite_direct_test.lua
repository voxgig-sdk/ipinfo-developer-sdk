...
describe("IpinfoLiteDirect", function()
  it("should direct-load-ipinfo_lite", function()
    local setup = ipinfo_lite_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ipinfo_lite", setup.live and "live" or "unit")
...
function ipinfo_lite_direct_setup(mockres)
