...
describe("IpinfoPlusDirect", function()
  it("should direct-load-ipinfo_plus", function()
    local setup = ipinfo_plus_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ipinfo_plus", setup.live and "live" or "unit")
...
function ipinfo_plus_direct_setup(mockres)
