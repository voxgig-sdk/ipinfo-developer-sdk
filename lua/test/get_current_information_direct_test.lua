-- GetCurrentInformation direct test
...
describe("GetCurrentInformationDirect", function()
  it("should direct-load-get_current_information", function()
    local setup = get_current_information_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_current_information", setup.live and "live" or "unit")
...
function get_current_information_direct_setup(mockres)
