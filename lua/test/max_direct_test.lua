...
describe("MaxDirect", function()
  it("should direct-load-max", function()
    local setup = max_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-max", setup.live and "live" or "unit")
...
function max_direct_setup(mockres)
