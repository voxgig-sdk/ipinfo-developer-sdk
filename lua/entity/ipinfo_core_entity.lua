...
local IpinfoCoreEntity = {}
IpinfoCoreEntity.__index = IpinfoCoreEntity


function IpinfoCoreEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IpinfoCoreEntity)
  self._name = "ipinfo_core"
  self._client = client
...
function IpinfoCoreEntity:get_name()
  return self._name
end


function IpinfoCoreEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IpinfoCoreEntity.new(self._client, opts)
end
...
function IpinfoCoreEntity:mark_deleted()
  self._deleted = true
end


function IpinfoCoreEntity:deleted()
  return true == self._deleted
end


function IpinfoCoreEntity:data_set(args)
  if args ~= nil then
...
function IpinfoCoreEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IpinfoCoreEntity:match_set(args)
  if args ~= nil then
...
function IpinfoCoreEntity:match_get()
...
function IpinfoCoreEntity:stream(action, args, callopts)
...
---@param reqmatch IpinfoCoreLoadMatch
---@param ctrl? table
---@return IpinfoCore
---@return string? err
function IpinfoCoreEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function IpinfoCoreEntity:_run_op(ctx, post_done)
  local utility = self._utility
