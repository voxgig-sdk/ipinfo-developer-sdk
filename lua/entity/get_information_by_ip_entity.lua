...
local GetInformationByIpEntity = {}
GetInformationByIpEntity.__index = GetInformationByIpEntity


function GetInformationByIpEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetInformationByIpEntity)
  self._name = "get_information_by_ip"
  self._client = client
...
function GetInformationByIpEntity:get_name()
  return self._name
end


function GetInformationByIpEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetInformationByIpEntity.new(self._client, opts)
end
...
function GetInformationByIpEntity:mark_deleted()
  self._deleted = true
end


function GetInformationByIpEntity:deleted()
  return true == self._deleted
end


function GetInformationByIpEntity:data_set(args)
  if args ~= nil then
...
function GetInformationByIpEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetInformationByIpEntity:match_set(args)
  if args ~= nil then
...
function GetInformationByIpEntity:match_get()
...
function GetInformationByIpEntity:stream(action, args, callopts)
...
---@param reqmatch GetInformationByIpLoadMatch
---@param ctrl? table
---@return GetInformationByIp
---@return string? err
function GetInformationByIpEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetInformationByIpEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetInformationByIpEntity
