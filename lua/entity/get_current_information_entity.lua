...
local GetCurrentInformationEntity = {}
GetCurrentInformationEntity.__index = GetCurrentInformationEntity


function GetCurrentInformationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetCurrentInformationEntity)
  self._name = "get_current_information"
  self._client = client
...
function GetCurrentInformationEntity:get_name()
  return self._name
end


function GetCurrentInformationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetCurrentInformationEntity.new(self._client, opts)
end
...
function GetCurrentInformationEntity:mark_deleted()
  self._deleted = true
end


function GetCurrentInformationEntity:deleted()
  return true == self._deleted
end


function GetCurrentInformationEntity:data_set(args)
  if args ~= nil then
...
function GetCurrentInformationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetCurrentInformationEntity:match_set(args)
  if args ~= nil then
...
function GetCurrentInformationEntity:match_get()
...
function GetCurrentInformationEntity:stream(action, args, callopts)
...
function GetCurrentInformationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetCurrentInformationEntity
