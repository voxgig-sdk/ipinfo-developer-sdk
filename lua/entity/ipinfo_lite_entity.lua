...
local IpinfoLiteEntity = {}
IpinfoLiteEntity.__index = IpinfoLiteEntity


function IpinfoLiteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IpinfoLiteEntity)
  self._name = "ipinfo_lite"
  self._client = client
...
function IpinfoLiteEntity:get_name()
  return self._name
end


function IpinfoLiteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IpinfoLiteEntity.new(self._client, opts)
end
...
function IpinfoLiteEntity:mark_deleted()
  self._deleted = true
end


function IpinfoLiteEntity:deleted()
  return true == self._deleted
end


function IpinfoLiteEntity:data_set(args)
  if args ~= nil then
...
function IpinfoLiteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IpinfoLiteEntity:match_set(args)
  if args ~= nil then
...
function IpinfoLiteEntity:match_get()
...
function IpinfoLiteEntity:stream(action, args, callopts)
...
---@param reqmatch IpinfoLiteLoadMatch
---@param ctrl? table
---@return IpinfoLite
---@return string? err
function IpinfoLiteEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function IpinfoLiteEntity:_run_op(ctx, post_done)
  local utility = self._utility
