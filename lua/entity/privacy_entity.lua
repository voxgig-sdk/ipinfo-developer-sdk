...
local PrivacyEntity = {}
PrivacyEntity.__index = PrivacyEntity


function PrivacyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PrivacyEntity)
  self._name = "privacy"
  self._client = client
...
function PrivacyEntity:get_name()
  return self._name
end


function PrivacyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PrivacyEntity.new(self._client, opts)
end
...
function PrivacyEntity:mark_deleted()
  self._deleted = true
end


function PrivacyEntity:deleted()
  return true == self._deleted
end


function PrivacyEntity:data_set(args)
  if args ~= nil then
...
function PrivacyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PrivacyEntity:match_set(args)
  if args ~= nil then
...
function PrivacyEntity:match_get()
...
function PrivacyEntity:stream(action, args, callopts)
...
---@param reqmatch PrivacyLoadMatch
---@param ctrl? table
---@return Privacy
---@return string? err
function PrivacyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function PrivacyEntity:_run_op(ctx, post_done)
  local utility = self._utility
