# IpinfoDeveloper SDK — Agent Guide
...
**Entities** (28): `Abuse`, `Asn`, `Carrier`, `Company`, `Core`, `Domain`, `General`, `GetCurrentInformation`, `GetInformationByIp`, `IpinfoCore`, `IpinfoLite`, `IpinfoPlus`, `Lite`, `Max`, `Men`, `Place`, `Plus`, `Privacy`, `PrivacyExtended`, `Range`, `ResidentialProxy`, `Single`, `WhoisAsn`, `WhoisDomain`, `WhoisIp`, `WhoisNetId`, `WhoisOrg`, `WhoisPoc`.
