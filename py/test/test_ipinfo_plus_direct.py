...
class TestIpinfoPlusDirect:

    def test_should_direct_load_ipinfo_plus(self):
        setup = _ipinfo_plus_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-ipinfo_plus", "live" if setup["live"] else "unit")
        if _skip:
...
def _ipinfo_plus_direct_setup(mockres):
