    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set IPINFO_DEVELOPER_TEST_GENERAL_ENTID JSON to run live")
        client = setup["client"]
        ...
        general_ref01_data = helpers.to_map(runner.entity_data(general_ref01_ent.create(general_ref01_data, None)))
...
def _general_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "IPINFO_DEVELOPER_TEST_GENERAL_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("IPINFO_DEVELOPER_TEST_GENERAL_ENTID"))
