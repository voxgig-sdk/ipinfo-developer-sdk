    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set IPINFODEVELOPER_TEST_IPINFO_PLUS_ENTID JSON to run live")
        client = setup["client"]
        ...
        ipinfo_plus_ref01_data_dt0_loaded, err = ipinfo_plus_ref01_ent.load(ipinfo_plus_ref01_match_dt0, None)
        assert err is None
...
def _ipinfo_plus_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "IPINFODEVELOPER_TEST_IPINFO_PLUS_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("IPINFODEVELOPER_TEST_IPINFO_PLUS_ENTID"))
