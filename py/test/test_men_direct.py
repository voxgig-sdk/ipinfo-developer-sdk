...
class TestMenDirect:
    ...
    def test_should_direct_load_men(self):
        setup = _men_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-men", "live" if setup["live"] else "unit")
        if _skip:
