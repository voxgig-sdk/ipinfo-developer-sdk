...
class TestAsnDirect:
    ...
    def test_should_direct_list_asn(self):
        setup = _asn_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-asn", "live" if setup["live"] else "unit")
        if _skip:
