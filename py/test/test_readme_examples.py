# IpinfoDeveloper SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpinfoDeveloperSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpinfoDeveloperSDK(...) and IpinfoDeveloperSDK.test(...) become
#      IpinfoDeveloperSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipinfodeveloper_sdk"
_SDK_CLASS = "IpinfoDeveloperSDK"
...
_ENTITIES = {
    ...
    "Domain": "domain",
    "General": "general",
    "GetCurrentInformation": "get_current_information",
    "GetInformationByIp": "get_information_by_ip",
    "IpinfoCore": "ipinfo_core",
    "IpinfoLite": "ipinfo_lite",
    "IpinfoPlus": "ipinfo_plus",
    "Lite": "lite",
    "Max": "max",
    "Men": "men",
    "Place": "place",
    "Plus": "plus",
    "Privacy": "privacy",
    "PrivacyExtended": "privacy_extended",
    "Range": "range",
    "ResidentialProxy": "residential_proxy",
    "Single": "single",
    "WhoisAsn": "whois_asn",
    "WhoisDomain": "whois_domain",
    "WhoisIp": "whois_ip",
    "WhoisNetId": "whois_net_id",
    "WhoisOrg": "whois_org",
    "WhoisPoc": "whois_poc",
}
