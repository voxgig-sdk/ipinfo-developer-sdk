...
from ipinfodeveloper_sdk.core.helpers import get_ctx_prop, to_map
...
class IpinfoDeveloperContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IpinfoDeveloperControl()
        ...
        if isinstance(sp, IpinfoDeveloperSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpinfoDeveloperResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpinfoDeveloperResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IpinfoDeveloperOperation({})
    ...
    def make_error(self, code, msg):
        return IpinfoDeveloperError(code, msg, self)
