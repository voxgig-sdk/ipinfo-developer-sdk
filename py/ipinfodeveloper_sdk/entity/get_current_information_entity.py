...
from ipinfodeveloper_sdk.ipinfodeveloper_types import (
...
class GetCurrentInformationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetCurrentInformationEntity(self._client, opts)
    ...
    def data_get(self) -> GetCurrentInformation:
    ...
    def match_get(self) -> GetCurrentInformation:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetCurrentInformation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetCurrentInformation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
