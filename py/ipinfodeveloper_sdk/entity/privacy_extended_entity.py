...
class PrivacyExtendedEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PrivacyExtendedEntity(self._client, opts)
    ...
    def data_get(self) -> PrivacyExtended:
    ...
    def match_get(self) -> PrivacyExtended:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PrivacyExtended]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PrivacyExtended().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
