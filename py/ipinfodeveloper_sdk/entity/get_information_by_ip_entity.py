...
class GetInformationByIpEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetInformationByIpEntity(self._client, opts)
    ...
    def data_get(self) -> GetInformationByIp:
    ...
    def match_get(self) -> GetInformationByIp:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetInformationByIp:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetInformationByIp().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
