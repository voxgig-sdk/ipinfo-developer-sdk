...
class PlaceEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IPINFODEVELOPER_TEST_PLACE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def place_basic_setup(extra)
  ...
  entid_env_raw = ENV["IPINFODEVELOPER_TEST_PLACE_ENTID"]
