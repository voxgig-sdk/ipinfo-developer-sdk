...
class GetInformationByIpEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IPINFO_DEVELOPER_TEST_GET_INFORMATION_BY_IP_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def get_information_by_ip_basic_setup(extra)
  ...
  entid_env_raw = ENV["IPINFO_DEVELOPER_TEST_GET_INFORMATION_BY_IP_ENTID"]
