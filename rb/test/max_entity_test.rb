...
class MaxEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IPINFO_DEVELOPER_TEST_MAX_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def max_basic_setup(extra)
  ...
  entid_env_raw = ENV["IPINFO_DEVELOPER_TEST_MAX_ENTID"]
