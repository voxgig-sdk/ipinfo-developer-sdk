...
#      offline in seeded test mode (IpinfoDeveloperSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpinfoDeveloper_sdk.rb")
  SDK_CLASS = "IpinfoDeveloperSDK"
