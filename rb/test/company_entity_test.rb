...
class CompanyEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IPINFO_DEVELOPER_TEST_COMPANY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
    ...
    assert !company_ref01_data_dt0_loaded.nil?
...
def company_basic_setup(extra)
  ...
  entid_env_raw = ENV["IPINFO_DEVELOPER_TEST_COMPANY_ENTID"]
