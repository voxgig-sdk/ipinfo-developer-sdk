...
class IpinfoLiteEntity
  ...
  def make
    opts = @_entopts.dup
    IpinfoLiteEntity.new(@_client, opts)
  end
  ...
  # @return [IpinfoLite, Hash] the current IpinfoLite data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IpinfoLite fields)
  def match_get
  ...
  #
  # @param reqmatch [IpinfoLiteLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.IpinfoLite.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [IpinfoLite, Hash] the loaded IpinfoLite; raises IpinfoDeveloperError on failure
