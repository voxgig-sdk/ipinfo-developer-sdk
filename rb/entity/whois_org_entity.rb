...
class WhoisOrgEntity
  ...
  def make
    opts = @_entopts.dup
    WhoisOrgEntity.new(@_client, opts)
  end
  ...
  # @return [WhoisOrg, Hash] the current WhoisOrg data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WhoisOrg fields)
  def match_get
  ...
  #
  # @param reqmatch [WhoisOrgLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.WhoisOrg.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [WhoisOrg, Hash] the loaded WhoisOrg; raises IpinfoDeveloperError on failure
