...
class CarrierEntity
  ...
  def make
    opts = @_entopts.dup
    CarrierEntity.new(@_client, opts)
  end
  ...
  # @return [Carrier, Hash] the current Carrier data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Carrier fields)
  def match_get
  ...
  #
  # @param reqmatch [CarrierLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Carrier.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Carrier, Hash] the loaded Carrier; raises IpinfoDeveloperError on failure
