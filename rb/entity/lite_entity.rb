...
class LiteEntity
  ...
  # @return [Lite, Hash] the current Lite data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Lite fields)
  def match_get
  ...
  # Load a single Lite.
  #
  # @param reqmatch [LiteLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Lite.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Lite, Hash] the loaded Lite; raises IpinfoDeveloperError on failure
