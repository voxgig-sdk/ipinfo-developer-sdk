...
class AbuseEntity
  ...
  # @return [Abuse, Hash] the current Abuse data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Abuse fields)
  def match_get
  ...
  # Load a single Abuse.
  #
  # @param reqmatch [AbuseLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Abuse.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Abuse, Hash] the loaded Abuse; raises IpinfoDeveloperError on failure
