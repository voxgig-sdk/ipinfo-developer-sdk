...
class SingleEntity
  ...
  # @return [Single, Hash] the current Single data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Single fields)
  def match_get
  ...
  #
  # @param reqmatch [SingleLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Single.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Single, Hash] the loaded Single; raises IpinfoDeveloperError on failure
