...
class WhoisAsnEntity
  ...
  def make
    opts = @_entopts.dup
    WhoisAsnEntity.new(@_client, opts)
  end
  ...
  # @return [WhoisAsn, Hash] the current WhoisAsn data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WhoisAsn fields)
  def match_get
  ...
  #
  # @param reqmatch [WhoisAsnListMatch, Hash, nil] match filter (any subset of
  #   WhoisAsn fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<WhoisAsn>, Array] the matching WhoisAsn items; raises IpinfoDeveloperError on failure
