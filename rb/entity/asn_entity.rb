...
class AsnEntity
  ...
  # @return [Asn, Hash] the current Asn data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Asn fields)
  def match_get
  ...
  #
  # @param reqmatch [AsnListMatch, Hash, nil] match filter (any subset of
  #   Asn fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Asn>, Array] the matching Asn items; raises IpinfoDeveloperError on failure
