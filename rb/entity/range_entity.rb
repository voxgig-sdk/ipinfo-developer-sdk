...
class RangeEntity
  ...
  # @return [Range, Hash] the current Range data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Range fields)
  def match_get
  ...
  # Load a single Range.
  #
  # @param reqmatch [RangeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Range.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Range, Hash] the loaded Range; raises IpinfoDeveloperError on failure
