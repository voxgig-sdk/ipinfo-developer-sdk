...
class PrivacyExtendedEntity
  ...
  def make
    opts = @_entopts.dup
    PrivacyExtendedEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [PrivacyExtendedListMatch, Hash, nil] match filter (any subset of
  #   PrivacyExtended fields); defaults to nil, treated as an empty match that lists all.
