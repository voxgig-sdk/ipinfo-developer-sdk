...
class GetInformationByIpEntity
  ...
  def make
    opts = @_entopts.dup
    GetInformationByIpEntity.new(@_client, opts)
  end
  ...
  # @return [GetInformationByIp, Hash] the current GetInformationByIp data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetInformationByIp fields)
  def match_get
  ...
  #
  # @param reqmatch [GetInformationByIpLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GetInformationByIp.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetInformationByIp, Hash] the loaded GetInformationByIp; raises IpinfoDeveloperError on failure
