...
class MaxEntity
  ...
  # @return [Max, Hash] the current Max data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Max fields)
  def match_get
  ...
  # Load a single Max.
  #
  # @param reqmatch [MaxLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Max.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Max, Hash] the loaded Max; raises IpinfoDeveloperError on failure
