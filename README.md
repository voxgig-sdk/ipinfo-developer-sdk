...
Official OpenAPI Specification for IPinfo's comprehensive IP intelligence API.

Learn more about IPinfo.io OpenAPI Specification at [ipinfo.io/developers](https://ipinfo.io/developers).
...
This SDK exposes the API as **28 semantic entities** that you
...
local abuse, err = client:Abuse():load({ ip = "example_ip" })
print(abuse)
```
