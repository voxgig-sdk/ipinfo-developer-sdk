...
class PlusDirectTest extends TestCase
{
    public function test_direct_load_plus(): void
    {
        $setup = plus_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-plus", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
