...
// IpinfoDeveloper SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpinfoDeveloperSDK::test)
...
{
    private const SDK_CLASS = 'IpinfoDeveloperSDK';
    ...
    private const SDK_BASE = 'ipinfodeveloper_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipinfodeveloper_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
