...
class WhoisNetIdDirectTest extends TestCase
{
    public function test_direct_load_whois_net_id(): void
    {
        $setup = whois_net_id_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-whois_net_id", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
