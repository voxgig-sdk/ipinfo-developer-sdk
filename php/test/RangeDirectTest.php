...
class RangeDirectTest extends TestCase
{
    public function test_direct_load_range(): void
    {
        $setup = range_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-range", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
