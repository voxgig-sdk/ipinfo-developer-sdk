...
class PrivacyDirectTest extends TestCase
{
    public function test_direct_load_privacy(): void
    {
        $setup = privacy_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-privacy", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
