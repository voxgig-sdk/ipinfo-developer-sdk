...
class AbuseDirectTest extends TestCase
{
    public function test_direct_load_abuse(): void
    {
        $setup = abuse_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-abuse", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
