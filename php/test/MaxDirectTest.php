...
class MaxDirectTest extends TestCase
{
    public function test_direct_load_max(): void
    {
        $setup = max_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-max", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
