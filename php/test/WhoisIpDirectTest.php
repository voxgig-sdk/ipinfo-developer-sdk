...
class WhoisIpDirectTest extends TestCase
{
    public function test_direct_load_whois_ip(): void
    {
        $setup = whois_ip_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-whois_ip", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
