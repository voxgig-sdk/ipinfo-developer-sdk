...
class AsnDirectTest extends TestCase
{
    public function test_direct_list_asn(): void
    {
        $setup = asn_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-asn", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
