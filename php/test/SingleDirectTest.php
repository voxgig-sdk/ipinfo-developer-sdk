...
class SingleDirectTest extends TestCase
{
    public function test_direct_load_single(): void
    {
        $setup = single_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-single", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
