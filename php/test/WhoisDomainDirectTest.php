...
class WhoisDomainDirectTest extends TestCase
{
    public function test_direct_load_whois_domain(): void
    {
        $setup = whois_domain_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-whois_domain", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
