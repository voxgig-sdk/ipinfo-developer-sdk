...
class CoreEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IPINFODEVELOPER_TEST_CORE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function core_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IPINFODEVELOPER_TEST_CORE_ENTID");
