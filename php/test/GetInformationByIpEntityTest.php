...
class GetInformationByIpEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IPINFO_DEVELOPER_TEST_GET_INFORMATION_BY_IP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function get_information_by_ip_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IPINFO_DEVELOPER_TEST_GET_INFORMATION_BY_IP_ENTID");
