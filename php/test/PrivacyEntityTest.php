...
class PrivacyEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IPINFO_DEVELOPER_TEST_PRIVACY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function privacy_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IPINFO_DEVELOPER_TEST_PRIVACY_ENTID");
