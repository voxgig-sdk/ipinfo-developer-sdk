...
class CarrierDirectTest extends TestCase
{
    public function test_direct_load_carrier(): void
    {
        $setup = carrier_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-carrier", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
