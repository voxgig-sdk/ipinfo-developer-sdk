...
class IpinfoCoreDirectTest extends TestCase
{
    public function test_direct_load_ipinfo_core(): void
    {
        $setup = ipinfo_core_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ipinfo_core", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
