...
class LiteDirectTest extends TestCase
{
    public function test_direct_load_lite(): void
    {
        $setup = lite_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-lite", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
