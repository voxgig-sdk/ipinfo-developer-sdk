...
class WhoisPocDirectTest extends TestCase
{
    public function test_direct_load_whois_poc(): void
    {
        $setup = whois_poc_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-whois_poc", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
