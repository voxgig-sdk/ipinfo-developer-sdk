...
class WhoisOrgDirectTest extends TestCase
{
    public function test_direct_load_whois_org(): void
    {
        $setup = whois_org_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-whois_org", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
