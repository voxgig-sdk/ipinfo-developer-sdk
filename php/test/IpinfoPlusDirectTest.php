...
class IpinfoPlusDirectTest extends TestCase
{
    public function test_direct_load_ipinfo_plus(): void
    {
        $setup = ipinfo_plus_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ipinfo_plus", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
