...
class MenDirectTest extends TestCase
{
    public function test_direct_load_men(): void
    {
        $setup = men_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-men", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
