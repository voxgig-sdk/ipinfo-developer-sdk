...
class IpinfoLiteDirectTest extends TestCase
{
    public function test_direct_load_ipinfo_lite(): void
    {
        $setup = ipinfo_lite_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ipinfo_lite", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
