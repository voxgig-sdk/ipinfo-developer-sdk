...
// IpinfoDeveloper SDK debug feature
...
class IpinfoDeveloperDebugFeature extends IpinfoDeveloperBaseFeature
{
    ...
    private function _finish(IpinfoDeveloperContext $ctx, bool $ok): void
    {
