...
// IpinfoDeveloper SDK timeout feature
...
class IpinfoDeveloperTimeoutFeature extends IpinfoDeveloperBaseFeature
{
    ...
    private function _with_timeout(IpinfoDeveloperContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpinfoDeveloperContext $_ctx, float $ms): void
    {
        $client = $this->client;
