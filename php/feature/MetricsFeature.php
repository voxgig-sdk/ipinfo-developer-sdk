...
// IpinfoDeveloper SDK metrics feature
...
class IpinfoDeveloperMetricsFeature extends IpinfoDeveloperBaseFeature
{
    ...
    private function _record(IpinfoDeveloperContext $ctx, bool $ok): void
    {
