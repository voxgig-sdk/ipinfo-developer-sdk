...
// IpinfoDeveloper SDK streaming feature
...
class IpinfoDeveloperStreamingFeature extends IpinfoDeveloperBaseFeature
{
    ...
    private function _iterate(IpinfoDeveloperResult $result): \Generator
    {
    ...
    private function _streamable(IpinfoDeveloperContext $ctx): bool
    {
