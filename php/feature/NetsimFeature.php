...
// IpinfoDeveloper SDK netsim feature
...
class IpinfoDeveloperNetsimFeature extends IpinfoDeveloperBaseFeature
{
    ...
    private function _simulate(IpinfoDeveloperContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpinfoDeveloperContext $ctx, array $applied): void
    {
        $client = $this->client;
