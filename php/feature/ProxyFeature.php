...
// IpinfoDeveloper SDK proxy feature
...
class IpinfoDeveloperProxyFeature extends IpinfoDeveloperBaseFeature
{
    ...
    public function init(IpinfoDeveloperContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpinfoDeveloperContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
