...
// IpinfoDeveloper SDK clienttrack feature
...
class IpinfoDeveloperClienttrackFeature extends IpinfoDeveloperBaseFeature
{
    ...
    public function PostConstruct(IpinfoDeveloperContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpinfoDeveloper-SDK';
