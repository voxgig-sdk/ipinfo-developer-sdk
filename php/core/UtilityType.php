...
// IpinfoDeveloper SDK utility type

class IpinfoDeveloperUtility
{
    ...
    public static function copy(IpinfoDeveloperUtility $src): IpinfoDeveloperUtility
    {
        $u = new IpinfoDeveloperUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
