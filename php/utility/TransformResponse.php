...
// IpinfoDeveloper SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class IpinfoDeveloperTransformResponse
{
    public static function call(IpinfoDeveloperContext $ctx): mixed
    {
        ...
        $transform = IpinfoDeveloperHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
