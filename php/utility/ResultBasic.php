...
// IpinfoDeveloper SDK utility: result_basic

class IpinfoDeveloperResultBasic
{
    public static function call(IpinfoDeveloperContext $ctx): ?IpinfoDeveloperResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof IpinfoDeveloperError) ? $result->err->msg : (string)$result->err;
