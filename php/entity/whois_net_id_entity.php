...
// IpinfoDeveloper SDK WhoisNetId entity
...
class WhoisNetIdEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WhoisNetIdEntity($this->_client, $opts);
    }

    /**
     * @param WhoisNetId|array $args WhoisNetId data (assoc-array) to store.
     */
    ...
    /**
     * @return WhoisNetId|array The current WhoisNetId data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WhoisNetId fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WhoisNetId fields).
     */
     ...
     *
     * @param WhoisNetIdLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WhoisNetIdLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WhoisNetId|array The loaded WhoisNetId as an assoc-array at the
