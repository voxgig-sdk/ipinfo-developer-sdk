...
// IpinfoDeveloper SDK Asn entity
...
class AsnEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AsnEntity($this->_client, $opts);
    }

    /**
     * @param Asn|array $args Asn data (assoc-array) to store.
     */
    ...
    /**
     * @return Asn|array The current Asn data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Asn fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Asn fields).
     */
    ...
    /**
     * List Asn items matching the given filter.
     *
     * @param AsnListMatch|array|null $reqmatch Match filter (any subset
     *   of Asn fields) as an assoc-array; AsnListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Asn[]|array A list of Asn items as assoc-arrays at
