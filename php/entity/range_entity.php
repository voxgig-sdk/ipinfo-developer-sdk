...
// IpinfoDeveloper SDK Range entity
...
class RangeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RangeEntity($this->_client, $opts);
    }

    /**
     * @param Range|array $args Range data (assoc-array) to store.
     */
    ...
    /**
     * @return Range|array The current Range data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Range fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Range fields).
     */
     ...
     * Load a single Range.
     *
     * @param RangeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RangeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Range|array The loaded Range as an assoc-array at the
