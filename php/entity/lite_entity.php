...
// IpinfoDeveloper SDK Lite entity
...
class LiteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LiteEntity($this->_client, $opts);
    }

    /**
     * @param Lite|array $args Lite data (assoc-array) to store.
     */
    ...
    /**
     * @return Lite|array The current Lite data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Lite fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Lite fields).
     */
     ...
     * Load a single Lite.
     *
     * @param LiteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LiteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Lite|array The loaded Lite as an assoc-array at the
