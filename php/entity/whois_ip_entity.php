...
class WhoisIpEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WhoisIpEntity($this->_client, $opts);
    }

    /**
     * @param WhoisIp|array $args WhoisIp data (assoc-array) to store.
     */
    ...
    /**
     * @return WhoisIp|array The current WhoisIp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WhoisIp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WhoisIp fields).
     */
    ...
    /**
     * Load a single WhoisIp.
     *
     * @param WhoisIpLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WhoisIpLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WhoisIp|array The loaded WhoisIp as an assoc-array at the
