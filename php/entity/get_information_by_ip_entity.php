...
// IpinfoDeveloper SDK GetInformationByIp entity
...
class GetInformationByIpEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "get_information_by_ip";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GetInformationByIpEntity($this->_client, $opts);
    }

    /**
     * @param GetInformationByIp|array $args GetInformationByIp data (assoc-array) to store.
     */
    ...
    /**
     * @return GetInformationByIp|array The current GetInformationByIp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetInformationByIp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetInformationByIp fields).
     */
    ...
    /**
     * Load a single GetInformationByIp.
     *
     * @param GetInformationByIpLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GetInformationByIpLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetInformationByIp|array The loaded GetInformationByIp as an assoc-array at the
