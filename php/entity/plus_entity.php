...
// IpinfoDeveloper SDK Plus entity
...
class PlusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PlusEntity($this->_client, $opts);
    }

    /**
     * @param Plus|array $args Plus data (assoc-array) to store.
     */
    ...
    /**
     * @return Plus|array The current Plus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Plus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Plus fields).
     */
     ...
     * Load a single Plus.
     *
     * @param PlusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PlusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Plus|array The loaded Plus as an assoc-array at the
