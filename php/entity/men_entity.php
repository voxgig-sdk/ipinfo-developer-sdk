...
// IpinfoDeveloper SDK Men entity
...
class MenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MenEntity($this->_client, $opts);
    }

    /**
     * @param Men|array $args Men data (assoc-array) to store.
     */
    ...
    /**
     * @return Men|array The current Men data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Men fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Men fields).
     */
     ...
     * Load a single Men.
     *
     * @param MenLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MenLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Men|array The loaded Men as an assoc-array at the
