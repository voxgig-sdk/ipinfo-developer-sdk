...
// IpinfoDeveloper SDK WhoisAsn entity
...
class WhoisAsnEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WhoisAsnEntity($this->_client, $opts);
    }

    /**
     * @param WhoisAsn|array $args WhoisAsn data (assoc-array) to store.
     */
    ...
    /**
     * @return WhoisAsn|array The current WhoisAsn data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WhoisAsn fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WhoisAsn fields).
     */
    ...
    /**
     * List WhoisAsn items matching the given filter.
     *
     * @param WhoisAsnListMatch|array|null $reqmatch Match filter (any subset
     *   of WhoisAsn fields) as an assoc-array; WhoisAsnListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WhoisAsn[]|array A list of WhoisAsn items as assoc-arrays at
