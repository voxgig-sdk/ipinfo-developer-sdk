...
// IpinfoDeveloper SDK WhoisPoc entity
...
class WhoisPocEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WhoisPocEntity($this->_client, $opts);
    }

    /**
     * @param WhoisPoc|array $args WhoisPoc data (assoc-array) to store.
     */
    ...
    /**
     * @return WhoisPoc|array The current WhoisPoc data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WhoisPoc fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WhoisPoc fields).
     */
    ...
    /**
     * Load a single WhoisPoc.
     *
     * @param WhoisPocLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WhoisPocLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WhoisPoc|array The loaded WhoisPoc as an assoc-array at the
