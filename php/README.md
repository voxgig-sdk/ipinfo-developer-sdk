...
The PHP SDK for the IpinfoDeveloper API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Abuse(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->IpinfoDeveloper(null)->load(
    ["id" => "test01"], null
);
