// Command IpinfoDeveloper-mcp is an MCP server exposing the IpinfoDeveloper
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpinfoDeveloper_list  — list records of an entity
//	IpinfoDeveloper_load  — load a single record of an entity
//
