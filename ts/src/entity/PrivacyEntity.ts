...
class PrivacyEntity extends IpinfoDeveloperEntityBase<Privacy> {
  ...
  make(this: PrivacyEntity) {
    return new PrivacyEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: PrivacyLoadMatch, ctrl?: Control): Promise<PrivacyEntity> {
