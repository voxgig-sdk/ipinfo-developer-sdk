...
//     (\`new IpinfoDeveloperSDK(...)\` / \`IpinfoDeveloperSDK.test(...)\` become
//     \`IpinfoDeveloperSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'IpinfoDeveloperSDK'
...
const TEST_SEED = {"entity":{"abuse":{"test01":{"id":"test01"}},"asn":{"test01":{"id":"test01"}},"carrier":{"test01":{"id":"test01"}},"company":{"test01":{"id":"test01"}},"core":{"test01":{"id":"test01"}},"domain":{"test01":{"id":"test01"}},"general":{"test01":{"id":"test01"}},"get_current_information":{"test01":{"id":"test01"}},"get_information_by_ip":{"test01":{"id":"test01"}},"ipinfo_core":{"test01":{"id":"test01"}},"ipinfo_lite":{"test01":{"id":"test01"}},"ipinfo_plus":{"test01":{"id":"test01"}},"lite":{"test01":{"id":"test01"}},"max":{"test01":{"id":"test01"}},"men":{"test01":{"id":"test01"}},"place":{"test01":{"id":"test01"}},"plus":{"test01":{"id":"test01"}},"privacy":{"test01":{"id":"test01"}},"privacy_extended":{"test01":{"id":"test01"}},"range":{"test01":{"id":"test01"}},"residential_proxy":{"test01":{"id":"test01"}},"single":{"test01":{"id":"test01"}},"whois_asn":{"test01":{"id":"test01"}},"whois_domain":{"test01":{"id":"test01"}},"whois_ip":{"test01":{"id":"test01"}},"whois_net_id":{"test01":{"id":"test01"}},"whois_org":{"test01":{"id":"test01"}},"whois_poc":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new IpinfoDeveloperSDK(...)\` and any
// \`IpinfoDeveloperSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+IpinfoDeveloperSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/IpinfoDeveloperSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
