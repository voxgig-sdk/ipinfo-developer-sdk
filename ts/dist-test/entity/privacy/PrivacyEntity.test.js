...
(0, node_test_1.describe)('PrivacyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'privacy.' + op, live))
                return;
        }
        ...
        let privacy_ref01_data = Object.values(setup.data.existing.privacy)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/privacy/PrivacyTestData.json');
    ...
    let idmap = transform(['privacy01', 'privacy02', 'privacy03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IPINFO_DEVELOPER_TEST_PRIVACY_ENTID'];
...
//# sourceMappingURL=PrivacyEntity.test.js.map