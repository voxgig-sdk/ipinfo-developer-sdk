...
(0, node_test_1.describe)('PrivacyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-privacy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-privacy', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'IPINFO_DEVELOPER_TEST_PRIVACY_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_PRIVACY_ENTID'];
...
//# sourceMappingURL=PrivacyDirect.test.js.map