...
(0, node_test_1.describe)('SingleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-single', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-single', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_SINGLE_ENTID'];
...
//# sourceMappingURL=SingleDirect.test.js.map