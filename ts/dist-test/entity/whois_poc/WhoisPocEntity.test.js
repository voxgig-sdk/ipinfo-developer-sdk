...
(0, node_test_1.describe)('WhoisPocEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let whois_poc_ref01_data = Object.values(setup.data.existing.whois_poc)[0];
        // LOAD
        const whois_poc_ref01_ent = client.WhoisPoc();
        const whois_poc_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(whois_poc_ref01_data_dt0.id === whois_poc_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/whois_poc/WhoisPocTestData.json');
    ...
    let idmap = transform(['whois_poc01', 'whois_poc02', 'whois_poc03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=WhoisPocEntity.test.js.map