...
(0, node_test_1.describe)('WhoisPocDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-whois_poc', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-whois_poc', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_WHOIS_POC_ENTID'];
...
//# sourceMappingURL=WhoisPocDirect.test.js.map