...
(0, node_test_1.describe)('PrivacyExtendedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpinfoDeveloperSDK({
    ...
    (0, node_test_1.test)('direct-list-privacy_extended', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-privacy_extended', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["ip01"]))
            return;
...
function liveScenariosActive() { return false && process.env.IPINFO_DEVELOPER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'IPINFO_DEVELOPER_TEST_PRIVACY_EXTENDED_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.IpinfoDeveloperSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.IPINFO_DEVELOPER_APIKEY,
            secret: env.IPINFO_DEVELOPER_SECRET,
        }));
        let idmap = env['IPINFO_DEVELOPER_TEST_PRIVACY_EXTENDED_ENTID'];
    ...
    const client = new __1.IpinfoDeveloperSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PrivacyExtendedDirect.test.js.map