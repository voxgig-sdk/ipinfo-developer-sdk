...
(0, node_test_1.describe)('ResidentialProxyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-residential_proxy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-residential_proxy', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_RESIDENTIAL_PROXY_ENTID'];
...
//# sourceMappingURL=ResidentialProxyDirect.test.js.map