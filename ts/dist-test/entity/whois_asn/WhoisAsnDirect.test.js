...
(0, node_test_1.describe)('WhoisAsnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-whois_asn', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-whois_asn', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["asn01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_WHOIS_ASN_ENTID'];
...
//# sourceMappingURL=WhoisAsnDirect.test.js.map