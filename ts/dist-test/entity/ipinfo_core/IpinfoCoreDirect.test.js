...
(0, node_test_1.describe)('IpinfoCoreDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ipinfo_core', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ipinfo_core', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_IPINFO_CORE_ENTID'];
...
//# sourceMappingURL=IpinfoCoreDirect.test.js.map