...
(0, node_test_1.describe)('IpinfoPlusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ipinfo_plus', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ipinfo_plus', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["field01", "ip01"]))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'IPINFO_DEVELOPER_TEST_IPINFO_PLUS_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_IPINFO_PLUS_ENTID'];
...
//# sourceMappingURL=IpinfoPlusDirect.test.js.map