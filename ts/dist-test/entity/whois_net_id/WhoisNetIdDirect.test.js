...
(0, node_test_1.describe)('WhoisNetIdDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-whois_net_id', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-whois_net_id', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["whoisnetid01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_WHOIS_NET_ID_ENTID'];
...
//# sourceMappingURL=WhoisNetIdDirect.test.js.map