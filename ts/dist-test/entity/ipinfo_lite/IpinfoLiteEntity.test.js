...
(0, node_test_1.describe)('IpinfoLiteEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'ipinfo_lite.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set IPINFO_DEVELOPER_TEST_IPINFO_LITE_ENTID JSON to run live');
            return;
        }
        ...
        let ipinfo_lite_ref01_data = Object.values(setup.data.existing.ipinfo_lite)[0];
        // LOAD
        const ipinfo_lite_ref01_ent = client.IpinfoLite();
        const ipinfo_lite_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(ipinfo_lite_ref01_data_dt0.id === ipinfo_lite_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/ipinfo_lite/IpinfoLiteTestData.json');
    ...
    let idmap = transform(['ipinfo_lite01', 'ipinfo_lite02', 'ipinfo_lite03', 'me01', 'me02', 'me03', 'lite01', 'lite02', 'lite03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IPINFO_DEVELOPER_TEST_IPINFO_LITE_ENTID'];
...
//# sourceMappingURL=IpinfoLiteEntity.test.js.map