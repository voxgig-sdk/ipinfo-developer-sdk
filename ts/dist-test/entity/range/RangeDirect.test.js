...
(0, node_test_1.describe)('RangeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-range', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-range', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_RANGE_ENTID'];
...
//# sourceMappingURL=RangeDirect.test.js.map