...
(0, node_test_1.describe)('GetCurrentInformationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_current_information', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_current_information', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_GET_CURRENT_INFORMATION_ENTID'];
...
//# sourceMappingURL=GetCurrentInformationDirect.test.js.map