...
(0, node_test_1.describe)('LiteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-lite', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-lite', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_LITE_ENTID'];
...
//# sourceMappingURL=LiteDirect.test.js.map