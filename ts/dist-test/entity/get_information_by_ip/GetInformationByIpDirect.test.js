...
(0, node_test_1.describe)('GetInformationByIpDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_information_by_ip', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_information_by_ip', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_GET_INFORMATION_BY_IP_ENTID'];
...
//# sourceMappingURL=GetInformationByIpDirect.test.js.map