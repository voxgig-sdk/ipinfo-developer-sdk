...
(0, node_test_1.describe)('GetInformationByIpEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_information_by_ip/GetInformationByIpTestData.json');
    ...
    let idmap = transform(['get_information_by_ip01', 'get_information_by_ip02', 'get_information_by_ip03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['IPINFO_DEVELOPER_TEST_GET_INFORMATION_BY_IP_ENTID'];
...
//# sourceMappingURL=GetInformationByIpEntity.test.js.map