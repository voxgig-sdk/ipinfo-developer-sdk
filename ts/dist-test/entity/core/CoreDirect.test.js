...
(0, node_test_1.describe)('CoreDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-core', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-core', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'IPINFO_DEVELOPER_TEST_CORE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_CORE_ENTID'];
