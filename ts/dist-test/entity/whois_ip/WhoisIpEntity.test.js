...
(0, node_test_1.describe)('WhoisIpEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'whois_ip.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['whois_ip01', 'whois_ip02', 'whois_ip03', 'net01', 'net02', 'net03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IPINFO_DEVELOPER_TEST_WHOIS_IP_ENTID'];
