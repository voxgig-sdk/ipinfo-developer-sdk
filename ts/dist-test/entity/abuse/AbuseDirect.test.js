...
(0, node_test_1.describe)('AbuseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-abuse', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-abuse', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IPINFO_DEVELOPER_TEST_ABUSE_ENTID'];
...
//# sourceMappingURL=AbuseDirect.test.js.map