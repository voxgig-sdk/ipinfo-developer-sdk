...
(0, node_test_1.describe)('AbuseEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'abuse.' + op, live))
                return;
        }
        ...
        let abuse_ref01_data = Object.values(setup.data.existing.abuse)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/abuse/AbuseTestData.json');
    ...
    let idmap = transform(['abuse01', 'abuse02', 'abuse03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IPINFO_DEVELOPER_TEST_ABUSE_ENTID'];
...
//# sourceMappingURL=AbuseEntity.test.js.map