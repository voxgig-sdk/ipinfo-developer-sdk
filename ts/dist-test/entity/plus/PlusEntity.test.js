...
(0, node_test_1.describe)('PlusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'plus.' + op, live))
                return;
        }
        ...
        let plus_ref01_data = Object.values(setup.data.existing.plus)[0];
        // LOAD
        const plus_ref01_ent = client.Plus();
        const plus_ref01_match_dt0 = {};
        plus_ref01_match_dt0.id = plus_ref01_data.id;
        const plus_ref01_data_dt0 = (await plus_ref01_ent.load(plus_ref01_match_dt0)).data();
        (0, node_assert_1.default)(plus_ref01_data_dt0.id === plus_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/plus/PlusTestData.json');
    ...
    let idmap = transform(['plus01', 'plus02', 'plus03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IPINFO_DEVELOPER_TEST_PLUS_ENTID'];
...
//# sourceMappingURL=PlusEntity.test.js.map